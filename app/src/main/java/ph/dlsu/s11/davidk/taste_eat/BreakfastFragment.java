...
public class BreakfastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Query query = db.collection("recipes").whereEqualTo("cuisine", str_cuisine_name).whereEqualTo("meal", "breakfast");
        ...
        Log.d("TAGS ONCREATE CV", "FROM BREAKFAST: "+str_cuisine_name);
        return view;
